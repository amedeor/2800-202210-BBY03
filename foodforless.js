...
app.get("/get-deals", async (req, res) => {
  ...
  for (let deal of dealResults) {
    ...
    deals.push({ "deal_id": deal.deal_id, "user_id": deal.user_id, "deal_price": deal.deal_price, "deal_description": deal.deal_description, "deal_store_location": deal.deal_store_location, "deal_post_date": deal.deal_post_date, "deal_expiry_date": deal.deal_expiry_date, "photos": photoUrls, "names": deal.deal_name});
  }
