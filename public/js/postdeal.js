...
async function postDeal() {
  ...
  if (dealName.checkValidity() !== false && dealPrice.checkValidity() !== false && tinymce.activeEditor.getContent() !== "" &&
    ...
    formData.append("dealDescription", tinymce.activeEditor.getContent());
